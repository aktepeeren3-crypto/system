...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    iget-object v0, p0, Ln1/s;->a:Landroid/graphics/Canvas;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Landroidx/compose/ui/platform/j;->z(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, Landroidx/compose/ui/platform/j;->x(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, Landroidx/compose/ui/platform/j;->y(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v0, p1}, Landroidx/compose/ui/platform/j;->A(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    invoke-static {v0, p1}, Landroidx/compose/ui/platform/j;->B(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final clipRect(FFFFLandroid/graphics/Region$Op;)Z
    ...
    iget-object v1, p0, Ln1/s;->a:Landroid/graphics/Canvas;
...
.method public final disableZ()V
    ...
    invoke-static {v0}, Lv0/a;->e(Landroid/graphics/Canvas;)V
...
.method public final drawArc(FFFFFFZLandroid/graphics/Paint;)V
    ...
    iget-object v1, v0, Ln1/s;->a:Landroid/graphics/Canvas;
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {v0, p1, p2}, Ln1/q;->h(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-static {v0, p1, p2}, Landroidx/compose/ui/platform/b2;->k(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {v0, p1, p2, p3}, Landroidx/compose/ui/platform/b2;->l(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    invoke-static/range {v1 .. v8}, Ln1/q;->i(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {v1 .. v6}, Landroidx/compose/ui/platform/b2;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    invoke-static/range {v1 .. v8}, Landroidx/compose/ui/platform/n;->f(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p1, p2, p3}, Landroidx/compose/ui/platform/n;->d(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p1, p2, p3}, Landroidx/compose/ui/platform/n;->e(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    invoke-static/range {v1 .. v10}, Ln1/q;->j(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    invoke-static {v0}, Lv0/a;->b(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, Ln1/r;->q(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {v0, p1}, Ln1/r;->r(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-static {v0, p1}, Ln1/r;->s(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
